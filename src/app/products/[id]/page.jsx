...
// Varyantlı üründe seçim durumu VariantProvider'da tutulur: görsel, fiyat ve
// sepete ekle butonu seçilen varyanta göre güncellenir. Varyantsız üründe
// provider şeffaftır — ürünün kendi fiyatı/görseli gösterilir.
...
import { VariantProvider } from "@/components/catalog/VariantProvider";
import VariantImage from "@/components/catalog/VariantImage";
import VariantPicker from "@/components/catalog/VariantPicker";
import VariantPrice from "@/components/catalog/VariantPrice";
    ...
    <VariantProvider product={product}>
      <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 sm:py-10">
        ...
        <div className="grid gap-6 lg:grid-cols-2 lg:gap-12">
          {/* Görsel — seçili varyantın görseli varsa onu gösterir */}
          ...
          <div className="flex flex-col gap-4">
            ...
            <VariantPrice className="text-3xl font-extrabold text-ink" />

            {/* Seçenekler (Beden, Renk...) — varyantsız üründe hiç render edilmez */}
            <VariantPicker />
        ...
        <div className="fixed inset-x-0 bottom-14 z-40 border-t border-line bg-surface-card/95 p-3 backdrop-blur sm:hidden">
          <div className="flex items-center gap-2">
            <div className="shrink-0">
              ...
              <VariantPrice className="text-base font-bold text-ink" />
            </div>
            <AddToCartButton productId={product.id} />
            {whatsappUrl && (
              <a
